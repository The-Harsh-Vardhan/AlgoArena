...
def main():
    ...
    # Load results - construct path relative to the project root
    current_dir = os.path.dirname(os.path.abspath(__file__))
    project_root = os.path.dirname(current_dir)
    results_path = os.path.join(project_root, "01_Tabular_Data", "tabular", "tabular_results.json")
    ...
    """.format(df.index[0], df['Accuracy'].max(), df['F1_score'].max(), len(df)))
